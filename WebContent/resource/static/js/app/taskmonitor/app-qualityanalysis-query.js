 ...
 */
    ...
    var $html;
	var popuwnd;
	RTU.register("app.qualityanalysis.query.init", function() {
	...
	RTU.register("app.qualityanalysis.query.activate", function() { //使得popuwnd对象活动
		return function() {
			window.open("modules/qualityanalyse/qualityanalyse.html");
	...
	/*RTU.register("app.qualityanalysis.query.deactivate", function() { //隐藏
		return function() {
			if (popuwnd) {
				popuwnd.hidden();
			}
	...
	RTU.register("app.qualityanalysis.query.init", function() {
		data = RTU.invoke("app.setting.data", "qualityanalysis");
		if (data && data.isActive) {
			RTU.invoke("app.qualityanalysis.query.activate");  
		}		
		return function() {
			return true;
		};
