   ...
   // require("../realtimelocomotivequery/app-realtimelocomotivequery-query.js")
	...
	RTU.register("app.equipmentqualitytrack.query.init", function() {
		RTU.invoke("core.router.load",{
			url:"../app/modules/locomotivefeedback/app-locomotivefeedback.html",
			success:function(html){
				...
				$("#trainisantecedents_loco").inputTip({ text: "" });
				$("#trainisantecedents_checi").inputTip({ text: "" });
				$("#trainisantecedents_loco").unbind("blur").blur(function(){
					if($("#trainisantecedents_loco").val()!="")$("#trainisantecedents_checi").val("");
